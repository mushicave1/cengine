/*
    ...
    CENGINE_GPU_ loader generated by glad 0.1.36 on Wed Dec  4 20:58:35 2024.
...
int open_gl(void) {
#ifndef IS_UWP
    libGL = LoadLibraryW(L"CENGINE_GPU_32.dll");
    if(libGL != NULL) {
        void (* tmp)(void);
...
int open_gl(void) {
    ...
    static const char *NAMES[] = {
        "../Frameworks/CENGINE_GPU_.framework/CENGINE_GPU_",
        "/Library/Frameworks/CENGINE_GPU_.framework/CENGINE_GPU_",
        "/System/Library/Frameworks/CENGINE_GPU_.framework/CENGINE_GPU_",
        "/System/Library/Frameworks/CENGINE_GPU_.framework/Versions/Current/CENGINE_GPU_"
    };
#else
