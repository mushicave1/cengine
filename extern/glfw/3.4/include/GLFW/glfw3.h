 ...
 * A library for CENGINE_GPU_, window and input
 *------------------------------------------------------------------------
 ...
 *  @brief Functions and types related to CENGINE_GPU_ and CENGINE_GPU_ ES contexts.
 *
 *  This is the reference documentation for CENGINE_GPU_ and CENGINE_GPU_ ES context related
 ...
 * the macOS CENGINE_GPU_ header blocks the definition of ptrdiff_t by glext.h.
...
/* It is customary to use APIENTRY for CENGINE_GPU_ function pointer declarations on
 * all platforms.  Additionally, the Windows CENGINE_GPU_ header needs APIENTRY.
 */
#if !defined(APIENTRY)
 #if defined(_WIN32)
...
/* Some Windows CENGINE_GPU_ headers need this.
 */
...
/* Include the chosen CENGINE_GPU_ or CENGINE_GPU_ ES headers.
 */
 ...
 #include <GLES3/gl32.h>
  ...
  #include <CENGINE_GPU_/gl3.h>
  #if defined(GLFW_INCLUDE_GLEXT)
   #include <CENGINE_GPU_/gl3ext.h>
 ...
 *  current CENGINE_GPU_ or CENGINE_GPU_ ES context but no context is current on the calling
 ...
 *  requesting a non-existent CENGINE_GPU_ or CENGINE_GPU_ ES version like 2.7.
 *
 *  Requesting a valid but unavailable CENGINE_GPU_ or CENGINE_GPU_ ES version will instead
 ...
 *
 *  @par
 *  Some pre-installed Windows graphics drivers do not support CENGINE_GPU_.  AMD only
 *  supports CENGINE_GPU_ ES via EGL, while Nvidia and Intel only support it via
 *  a WGL or GLX extension.  macOS does not provide CENGINE_GPU_ ES at all.  The Mesa
 *  EGL, CENGINE_GPU_ and CENGINE_GPU_ ES libraries do not interface with the Nvidia binary
 *  driver.  Older graphics drivers do not support Vulkan.
 */
#define GLFW_API_UNAVAILABLE        0x00010006
/*! @brief The requested CENGINE_GPU_ or CENGINE_GPU_ ES version is not available.
 *
 *  The requested CENGINE_GPU_ or CENGINE_GPU_ ES version (including any requested context
 ...
 *
 *  @par
 *  Future invalid CENGINE_GPU_ and CENGINE_GPU_ ES versions, for example CENGINE_GPU_ 4.8 if 5.0
...
/*! @brief The specified window does not have an CENGINE_GPU_ or CENGINE_GPU_ ES context.
 *
 *  A window that does not have an CENGINE_GPU_ or CENGINE_GPU_ ES context was passed to
...
/*! @brief CENGINE_GPU_ stereoscopic rendering hint.
 *
 *  CENGINE_GPU_ stereoscopic rendering [hint](@ref GLFW_STEREO).
 */
...
/*! @brief CENGINE_GPU_ forward-compatibility hint and attribute.
 *
 *  CENGINE_GPU_ forward-compatibility [hint](@ref GLFW_CENGINE_GPU__FORWARD_COMPAT_hint)
 *  and [attribute](@ref GLFW_CENGINE_GPU__FORWARD_COMPAT_attrib).
 */
#define GLFW_CENGINE_GPU__FORWARD_COMPAT  0x00022006
 ...
 */
#define GLFW_CENGINE_GPU__DEBUG_CONTEXT   GLFW_CONTEXT_DEBUG
/*! @brief CENGINE_GPU_ profile hint and attribute.
 *
 *  CENGINE_GPU_ profile [hint](@ref GLFW_CENGINE_GPU__PROFILE_hint) and
 *  [attribute](@ref GLFW_CENGINE_GPU__PROFILE_attrib).
 */
#define GLFW_CENGINE_GPU__PROFILE         0x00022008
...
#define GLFW_CENGINE_GPU__API             0x00030001
#define GLFW_CENGINE_GPU__ES_API          0x00030002

#define GLFW_NO_ROBUSTNESS                   0
#define GLFW_NO_RESET_NOTIFICATION  0x00031001
#define GLFW_LOSE_CONTEXT_ON_RESET  0x00031002

#define GLFW_CENGINE_GPU__ANY_PROFILE              0
#define GLFW_CENGINE_GPU__CORE_PROFILE    0x00032001
#define GLFW_CENGINE_GPU__COMPAT_PROFILE  0x00032002
...
#define GLFW_ANGLE_PLATFORM_TYPE_CENGINE_GPU_  0x00037002
#define GLFW_ANGLE_PLATFORM_TYPE_CENGINE_GPU_ES 0x00037003
 ...
 *  compile-time options.  It should not be confused with the CENGINE_GPU_ or CENGINE_GPU_ ES version
 ...
 *
 *  For gamma correct rendering with CENGINE_GPU_ or CENGINE_GPU_ ES, see the @ref
 ...
 *
 *  This function creates a window and its associated CENGINE_GPU_ or CENGINE_GPU_ ES
 ...
 *  CENGINE_GPU_ or CENGINE_GPU_ ES context.
 *
 ...
 *  CENGINE_GPU_ implementation is the only one available.
 *
 ...
 *  any other thread.
 *
 *  @remark @macos The OS only supports core profile contexts for CENGINE_GPU_
 *  versions 3.2 and later.  Before creating an CENGINE_GPU_ context of version 3.2 or
 *  later you must set the [GLFW_CENGINE_GPU__PROFILE](@ref GLFW_CENGINE_GPU__PROFILE_hint)
 *  hint accordingly.  CENGINE_GPU_ 3.0 and 3.1 contexts are not supported at all
 *  on macOS.
 *
 ...
 *  GLFW_PLATFORM_ERROR.
 *
 *  @remark The CENGINE_GPU_ or CENGINE_GPU_ ES context will not be destroyed or otherwise
 ...
 *  its CENGINE_GPU_ or CENGINE_GPU_ ES context.
 *
 *  @param[in] window The window to query.
 ...
 *  thread.
 *
 *  This function makes the CENGINE_GPU_ or CENGINE_GPU_ ES context of the specified window
 ...
 *  hint.
 *
 *  The specified window must have an CENGINE_GPU_ or CENGINE_GPU_ ES context.  Specifying
 ...
 *
 *  This function returns the window whose CENGINE_GPU_ or CENGINE_GPU_ ES context is
 ...
 *  rendering with CENGINE_GPU_ or CENGINE_GPU_ ES.  If the swap interval is greater than
 ...
 *
 *  This function sets the swap interval for the current CENGINE_GPU_ or CENGINE_GPU_ ES
 ...
 *  [API extension](@ref context_glext) is supported by the current CENGINE_GPU_ or
 *  CENGINE_GPU_ ES context.  It searches both for client API extension and context
 ...
 *  context.
 *
 *  This function returns the address of the specified CENGINE_GPU_ or CENGINE_GPU_ ES
...
/* Some CENGINE_GPU_ related headers need GLAPIENTRY, but it is unconditionally
